    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center px-4">
      ...
      >
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-2">Votre essai gratuit a été activé avec succès</p>
          <p className="text-lg text-gray-500">
            Bienvenue {user.firstName}, vous pouvez maintenant profiter de Penpal AI !
          </p>
        </motion.div>
        ...
        >
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div className="bg-blue-50 rounded-xl p-4">
              <div className="text-2xl font-bold text-blue-600 mb-1">30 jours</div>
              <div className="text-sm text-gray-600">Essai gratuit</div>
            </div>
            <div className="bg-green-50 rounded-xl p-4">
              <div className="text-2xl font-bold text-green-600 mb-1">Illimité</div>
          ...
          <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              <strong>Rappel :</strong> Votre période d'essai se termine dans 30 jours. Vous pouvez
        ...
        >
          <p className="text-gray-500 text-sm">
            Redirection automatique vers le chat dans{' '}
            <span className="font-medium text-blue-600">{countdown}</span> secondes
          </p>
        </motion.div>
