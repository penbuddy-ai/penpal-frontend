 ...
 */
const ServiceHeader = memo<{ service?: ServiceHealth; loading: boolean }>(({ service, loading }) => {
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">GPT-4o Mini</p>
            </div>
          </div>
        </div>
      </div>
...
const ServiceInformation = memo(() => {
  ...
  const endpoints = [
    ...
    { method: 'POST', path: '/ai/conversation-partner', description: t('ai.endpoints.conversationPartner') },
    { method: 'POST', path: '/ai/analyze', description: t('ai.endpoints.analyze') },
    { method: 'GET', path: '/ai/conversation-starters', description: t('ai.endpoints.conversationStarters') },
